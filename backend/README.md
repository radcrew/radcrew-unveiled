...
- `app/chatbot/` — Assistant logic: `chat.py` (state + lifespan + stream entry), `langchain_service.py` (facade), plus `knowledge/`, `rag/` (RAG package entry), `graph/`, `huggingface/`, `feedback/`, `cache/`.
