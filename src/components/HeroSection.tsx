    ...
    <section className="relative min-h-[90vh] flex flex-col justify-center overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10" aria-hidden>
        <img
          src={heroTechBg}
          alt=""
          className="h-full min-h-[90vh] w-full object-fill"
        />
      ...
      <div className="section-padding relative z-10 mx-auto flex w-full max-w-6xl flex-col justify-center pt-24 pb-16">
