    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
      <div className="max-w-6xl mx-auto section-padding flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium">
          ...
          <a href="#workspace" className="text-muted-foreground hover:text-foreground transition-colors">Workspace</a>
      ...
      {open && (
        <div className="md:hidden border-t border-border bg-background section-padding py-4 flex flex-col gap-4 text-sm font-medium">
          ...
          <a href="#workspace" onClick={() => setOpen(false)} className="text-muted-foreground hover:text-foreground">Workspace</a>
